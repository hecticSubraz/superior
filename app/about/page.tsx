    ...
    <PageTransition>
      ...
      <section className="section-padding">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-12 grid gap-8 sm:mt-20 lg:grid-cols-2">
            <ScrollReveal>
              <div className="glass-card h-full p-8 sm:p-10">
                ...
                <h3 className="font-display text-xl font-bold text-foreground sm:text-2xl">Our Mission</h3>
            ...
            <ScrollReveal delay={0.15}>
              <div className="glass-card h-full p-8 sm:p-10">
                ...
                <h3 className="font-display text-xl font-bold text-foreground sm:text-2xl">Our Vision</h3>
                <p className="mt-4 leading-relaxed text-stone-600">
            ...
            {values.map((value, index) => (
              <ScrollReveal key={value.title} delay={index * 0.1}>
                <div className="glass-card-hover h-full p-6 text-center">
                  ...
                  <p className="mt-3 text-sm text-stone-600">{value.description}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
            ...
            {companyHistory.map((item, index) => (
              <ScrollReveal key={item.year} delay={index * 0.1}>
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-8">
                  <span className="font-display text-2xl font-bold text-accent sm:w-24 sm:text-3xl">
                    {item.year}
                  </span>
            ...
            {team.map((member, index) => (
              <ScrollReveal key={member.id} delay={index * 0.1}>
                <div className="glass-card-hover h-full p-6">
                  ...
                  <p className="mt-1 text-sm font-medium text-accent-dark">{member.role}</p>
                  <p className="mt-3 text-sm text-stone-600">{member.bio}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            ...
            <ScrollReveal delay={0.15}>
              ...
              <p className="mt-2 font-medium text-accent-dark">{managingDirector.position}</p>
