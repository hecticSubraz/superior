      ...
      <div className="relative mx-auto max-w-7xl px-4 pt-16 pb-8 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="group flex items-center gap-3">
              <div className="relative">
                <div className="absolute -inset-1.5 rounded-xl bg-accent/0 transition-all duration-300 group-hover:bg-accent/8" />
            ...
            <p className="mt-5 text-sm leading-relaxed text-muted">
              Nepal&apos;s trusted construction partner delivering excellence in
              building, infrastructure, and engineering solutions since 2009.
            </p>
            ...
            <ul className="space-y-3">
              {NAV_LINKS.map((link) => (
                <li key={link.href}>
                  ...
                  >
                    <span className="h-px w-3 bg-accent/0 transition-all group-hover:w-5 group-hover:bg-accent/70" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3 text-sm text-muted">
                <svg className="mt-0.5 h-4 w-4 shrink-0 text-accent/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                ...
                >
                  <svg className="h-4 w-4 shrink-0 text-accent/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              <li>
                <a
                  ...
                  className="flex items-center gap-3 break-all text-sm text-muted transition-colors hover:text-accent"
                >
                  <svg className="h-4 w-4 shrink-0 text-accent/70" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="mt-14 flex flex-col items-center justify-between gap-4 border-t border-stone-200 pt-7 sm:flex-row">
          ...
          <div className="flex items-center gap-4">
            <p className="text-xs text-muted">Built with excellence in Nepal 🇳🇵</p>
            <BackToTop />
          </div>
        </div>
      </div>
