    ...
    <footer className="border-t border-white/5 bg-surface">
      <div className="mx-auto max-w-7xl section-padding pb-8">
        <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div>
            <Link href="/" className="flex items-center gap-3">
              <Image src="/logo.svg" alt={SITE_NAME} width={40} height={40} />
              <div>
                <span className="font-display text-lg font-bold text-white">Superior</span>
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted">
              Nepal&apos;s trusted construction partner delivering excellence in building,
              infrastructure, and engineering solutions since 2009.
            </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/5 pt-8 sm:flex-row">
          ...
          <p className="text-xs text-muted">
            Built with excellence in Nepal
          </p>
        </div>
      </div>
    </footer>
